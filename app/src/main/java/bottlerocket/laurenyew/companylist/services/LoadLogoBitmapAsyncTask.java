...
public class LoadLogoBitmapAsyncTask extends AsyncTask<String, Void, Bitmap> {
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        if (imageViewReference != null) {
            ...
            if (imageView != null) {
                LoadLogoBitmapAsyncTask bitmapDownloaderTask = LoadLogoBitmapImageUtil.getLoadLogoBitmapAsyncTask(imageView);
                // Change bitmap only if this async task still applies
